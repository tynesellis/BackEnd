let MarkerData=[],Comments=[];const GetMarkerData=$.ajax({Method:"Get",url:"/Markers/GetMarkers"}).then(function(n){MarkerData=n;$("#address").attr("placeholder","Enter Your Address").prop("disabled",!1);$("#submit").prop("disabled",!1)}),GetComments=$.ajax({Method:"Get",url:"Comments/GetComments"}).then(function(n){Comments=n}),makeMarker=function(n,t,i){const u=new google.maps.Marker({map:t,position:n,icon:"http://maps.google.com/mapfiles/ms/icons/blue-dot.png",animation:google.maps.Animation.DROP});let e=Comments.filter(n=>n.markerId===i.id).sort((n,t)=>t.commentId-n.commentId),r=`

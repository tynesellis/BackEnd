let MarkerData=[],Comments=[];const GetMarkerData=function(){$("#standby").show();$.ajax({Method:"Get",url:"/Markers/GetMarkers"}).then(function(n){MarkerData=n;$("#standby").hide();setCenterMarker()})},GetComments=$.ajax({Method:"Get",url:"Comments/GetComments"}).then(function(n){Comments=n}),makeMarker=function(n,t,i){const u=new google.maps.Marker({map:t,position:n,icon:"http://maps.google.com/mapfiles/ms/icons/blue-dot.png",animation:google.maps.Animation.DROP});let e=Comments.filter(n=>n.markerId===i.id).sort((n,t)=>t.commentId-n.commentId),r=`
